...
insert  into `accounts`(`id`,`people_id`,`order_id`,`amount`,`date`,`type`,`state`,`remark`) values ('64c3b5a40c7611e79b99408d5cfa8d4a','C0001','O0001',4999,'2017-03-19 15:33:49','0','1','');
...
CREATE TABLE `inventory_log` (
  ...
  `type` varchar(1) DEFAULT NULL COMMENT '0原材料出库  1原材料入库  2原材料盘点  3产品入库  4产品出库  5产品盘点  6产品生产',
...
insert  into `inventory_log`(`id`,`date`,`type`,`description`) values ('011cb68d060e11e78f86408d5cfa8d4a','2017-03-11 11:51:28','5','产品（P0001:i7 7700k GTX1060 游戏主机）盘点'),('565666cb0c7411e79b99408d5cfa8d4a','2017-03-19 15:19:06','4','产品（P0001） 出售1台'),('6dd3c1b70bce11e7b6d0408d5cfa8d4a','2017-03-18 19:31:29','1','原材料（M0005）如库1件'),('6dd420360bce11e7b6d0408d5cfa8d4a','2017-03-18 19:31:29','1','原材料（M0008）如库1件'),('820c2b3a0bed11e7b6d0408d5cfa8d4a','2017-03-18 23:13:56','3','产品（P0001）生产1台'),('8fc591fe0be111e7b6d0408d5cfa8d4a','2017-03-18 21:48:30','1','原材料（M0005）入库1件'),('8fc5f5700be111e7b6d0408d5cfa8d4a','2017-03-18 21:48:30','1','原材料（M0008）入库1件'),('9229ac380c7211e79b99408d5cfa8d4a','2017-03-19 15:06:28','4','产品（P0001） 出售1台'),('bf5cfd220c7611e79b99408d5cfa8d4a','2017-03-19 15:36:21','4','产品（P0001） 出售1台'),('e9d98d9d0bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','3','产品（P0001）生产1台'),('e9daea1d0bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（爱国者T3分体式防尘台式电脑机箱 3.0大侧透网吧游戏水冷机箱批发 爱国者T3分体式防尘台式电脑机箱 3.0大侧透网吧游戏水冷机箱批发）生产消耗1件'),('e9db95b50bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（intel CPU 酷睿I7 7700K intel CPU 酷睿I7 7700K）生产消耗1件'),('e9dc1d5c0bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（影驰 GTX1060-3G 影驰 GTX1060-3G）生产消耗1件'),('e9dca0c90bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（希捷500G 硬盘 希捷500G 硬盘）生产消耗1件'),('e9dd467f0bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（Asus/华硕 PRIME B250M-K DDR4台式机游戏主板 支持7500 1151针 Asus/华硕 PRIME B250M-K DDR4台式机游戏主板 支持7500 1151针）生产消耗1件'),('e9ddcc280bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（金士顿DDR4 2133 8GB台式机内存 骇客神条Fury系列 HX421C14FB/8 金士顿DDR4 2133 8GB台式机内存 骇客神条Fury系列 HX421C14FB/8）生产消耗1件'),('e9de567e0bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（Aigo/爱国者额定500W电竞500电源 电脑台式机电源 Aigo/爱国者额定500W电竞500电源 电脑台式机电源）生产消耗1件'),('e9ded0760bed11e7b6d0408d5cfa8d4a','2017-03-18 23:16:53','0','原材料（九州风神 玄冰智能 九州风神 玄冰智能）生产消耗1件');
...
CREATE TABLE `logistics` (
  ...
  `goods_id` varchar(32) DEFAULT NULL COMMENT '商品或原材料id',
  `goods_amount` varchar(32) DEFAULT NULL COMMENT '商品或原材料数量',
  PRIMARY KEY (`id`)
...
insert  into `m_order`(`id`,`number`,`supplier_number`,`address`,`total_money`,`cancel_money`,`state`,`start_time`,`final_time`,`remark`) values ('5454b9560bb111e7b6d0408d5cfa8d4a','O0001','S0001','123',865,0,'3','2017-03-18 16:03:11','2017-03-18 16:03:11','123');
...
insert  into `m_order_detail`(`id`,`order_id`,`material_id`,`material_number`,`amount`,`cancel_amount`,`price`) values ('00e165bdff4711e6a107408d5cfa8d4a','fd7a82c2ff4611e6a107408d5cfa8d4a','62380dcaff4611e6a107408d5cfa8d4a','222',2,0,22),('68a917710bb711e7b6d0408d5cfa8d4a','5454b9560bb111e7b6d0408d5cfa8d4a','1130aedeffcf11e6ac32408d5cfa8d4a','M0005',1,0,405),('69c499360bce11e7b6d0408d5cfa8d4a','5454b9560bb111e7b6d0408d5cfa8d4a','ba4559a0ffcf11e6ac32408d5cfa8d4a','M0008',1,0,460);
...
insert  into `material_inventory`(`id`,`material_id`,`material_number`,`amount`) values ('0293dc00015b11e7ac0e408d5cfa8d4a','0293a305015b11e7ac0e408d5cfa8d4a','M0022',1),('11330552ffcf11e6ac32408d5cfa8d4a','1130aedeffcf11e6ac32408d5cfa8d4a','M0005',3),('18820597015b11e7ac0e408d5cfa8d4a','1881d441015b11e7ac0e408d5cfa8d4a','M0023',0),('1c5e34de015911e7ac0e408d5cfa8d4a','1c5dfbf6015911e7ac0e408d5cfa8d4a','M0019',-2),('3dcb4fcaffce11e6ac32408d5cfa8d4a','3dcaf740ffce11e6ac32408d5cfa8d4a','M0001',0),('40856543ffcf11e6ac32408d5cfa8d4a','40852a44ffcf11e6ac32408d5cfa8d4a','M00056',0),('60919270ffd111e6ac32408d5cfa8d4a','60914b7fffd111e6ac32408d5cfa8d4a','M0012',0),('677bad09ffcf11e6ac32408d5cfa8d4a','677b76c3ffcf11e6ac32408d5cfa8d4a','M0006',0),('83016b63ffd111e6ac32408d5cfa8d4a','83013fa7ffd111e6ac32408d5cfa8d4a','M0013',-2),('8e0bb2e4ffce11e6ac32408d5cfa8d4a','8e0b881dffce11e6ac32408d5cfa8d4a','M0002',0),('91effff9ffcf11e6ac32408d5cfa8d4a','91efc83affcf11e6ac32408d5cfa8d4a','M0007',-2),('98f58e0cffd011e6ac32408d5cfa8d4a','98f558d8ffd011e6ac32408d5cfa8d4a','M0011',0),('a3334b9c015c11e7ac0e408d5cfa8d4a','a3332697015c11e7ac0e408d5cfa8d4a','M0024',-2),('aac75e25ffd111e6ac32408d5cfa8d4a','aac72a0effd111e6ac32408d5cfa8d4a','M0014',0),('ba458b62ffcf11e6ac32408d5cfa8d4a','ba4559a0ffcf11e6ac32408d5cfa8d4a','M0008',2),('c02dc5d7015911e7ac0e408d5cfa8d4a','c02d928f015911e7ac0e408d5cfa8d4a','M0020',-2),('c78af9caffce11e6ac32408d5cfa8d4a','c78ac072ffce11e6ac32408d5cfa8d4a','M0003',0),('c8388205015811e7ac0e408d5cfa8d4a','c8385709015811e7ac0e408d5cfa8d4a','M0017',-2),('ce32588d015a11e7ac0e408d5cfa8d4a','ce322edf015a11e7ac0e408d5cfa8d4a','M0021',-2),('decdd1e0015d11e7ac0e408d5cfa8d4a','decd70ad015d11e7ac0e408d5cfa8d4a','M0025',0),('df698a47015811e7ac0e408d5cfa8d4a','df695a13015811e7ac0e408d5cfa8d4a','M0018',0),('e0edf494ffce11e6ac32408d5cfa8d4a','e0edb5d3ffce11e6ac32408d5cfa8d4a','M0004',0),('e3a5432cffd111e6ac32408d5cfa8d4a','e3a50feeffd111e6ac32408d5cfa8d4a','M0015',-2),('f5b6f38effcf11e6ac32408d5cfa8d4a','f5b6ba0effcf11e6ac32408d5cfa8d4a','M0009',0);
...
CREATE TABLE `order` (
  `id` varchar(32) NOT NULL,
  `costomerid` varchar(32) DEFAULT NULL COMMENT '顾客id',
  `total_amount` double DEFAULT NULL COMMENT '订单总金额',
  `state` varchar(1) DEFAULT NULL COMMENT '0 未完成 1 已完成',
  `start_time` date DEFAULT NULL COMMENT '下单时间',
...
CREATE TABLE `order_detail` (
  ...
  `amount` int(32) DEFAULT NULL COMMENT '总金额',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单详情表';
...
insert  into `p_order`(`id`,`number`,`customer_number`,`address`,`total_money`,`cancel_money`,`state`,`start_time`,`final_time`,`remark`) values ('e68f39230baf11e7b6d0408d5cfa8d4a','O0001','C0001','明德楼1 217',4999,0,'3','2017-03-18 00:00:00','2017-03-18 00:00:00','123');
...
insert  into `p_order_detail`(`id`,`order_id`,`product_id`,`product_number`,`amount`,`cancel_amount`,`price`) values ('4b1e13110c7111e79b99408d5cfa8d4a','e68f39230baf11e7b6d0408d5cfa8d4a','8f829cca019411e7ac0e408d5cfa8d4a','P0001',1,0,4999);
...
CREATE TABLE `product` (
  ...
  `description` varchar(500) DEFAULT NULL COMMENT '描述',
  `cpu_number` varchar(32) DEFAULT NULL,
  `radiator_number` varchar(32) DEFAULT NULL,
  `mainboard_number` varchar(32) DEFAULT NULL,
  `graphics_card_number` varchar(32) DEFAULT NULL,
  `memory_bank_number` varchar(32) DEFAULT NULL,
  `hard_drive_number` varchar(32) DEFAULT NULL,
  `case_number` varchar(32) DEFAULT NULL,
  `power_supply_number` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `number` (`number`)
...
insert  into `product`(`id`,`number`,`name`,`price`,`typeid`,`description`,`cpu_number`,`radiator_number`,`mainboard_number`,`graphics_card_number`,`memory_bank_number`,`hard_drive_number`,`case_number`,`power_supply_number`) values ('8f829cca019411e7ac0e408d5cfa8d4a','P0001','i7 7700k GTX1060 游戏主机',4999,'6092bc0b018711e7ac0e408d5cfa8d4a','','M0017','M0019','M0020','M0021','M0007','M0024','M0013','M0015');
...
insert  into `product_inventory`(`id`,`product_id`,`product_number`,`amount`) values ('8f89839f019411e7ac0e408d5cfa8d4a','8f829cca019411e7ac0e408d5cfa8d4a','P0001',1);
...
insert  into `production`(`id`,`product_number`,`amount`,`state`,`date`,`finish_time`) values (1,'P0001',1,'1','2017-03-18 19:47:59',NULL);
