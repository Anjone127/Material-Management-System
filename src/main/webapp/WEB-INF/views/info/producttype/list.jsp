...
<div class="iframe-wrap">
    ...
    <table id="producttype-table" class="table table-striped table-bordered table-hover" width="100%">
        <thead>
        <tr>
            <th>编号</th>
            <th>名称</th>
...
<script src="<c:url value='/js/info/producttype/list_main.js'/>"></script>
</body>
</html>
