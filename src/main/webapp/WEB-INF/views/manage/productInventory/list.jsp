...
<body>
    ...
    <table id="productInventory-table" class="table table-striped table-bordered table-hover" width="100%">
        <thead>
        <tr>
            <th>编号</th>
            <th>产品名称</th>
...
<script src="<c:url value='/js/manage/productInventory/list_main.js'/>"></script>
</body>
</html>
