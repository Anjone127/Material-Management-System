...
<body>
    ...
    <table id="materialInventory-table" class="table table-striped table-bordered table-hover" width="100%">
        <thead>
        <tr>
            <th>编号</th>
            <th>原材料名称</th>
...
<script src="<c:url value='/js/manage/materialInventory/list_main.js'/>"></script>
</body>
</html>
